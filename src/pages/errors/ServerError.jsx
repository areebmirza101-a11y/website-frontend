  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-white px-4">
      <div className="max-w-md w-full text-center">
        <div className="mb-6">
          <span className="text-8xl font-bold text-gray-900 tracking-tighter">500</span>
        </div>
        <h1 className="text-2xl font-bold text-gray-900 mb-3 tracking-tight">Server error</h1>
